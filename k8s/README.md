...
# 3. Verify images
docker images | grep -E "user-service|product-service|investment-service|payment-service|order-service|api-gateway|consumer|producer"
```
...
kubectl logs -n nexus -l app=consumer
```
